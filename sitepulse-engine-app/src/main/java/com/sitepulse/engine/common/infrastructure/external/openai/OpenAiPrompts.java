...
public final class OpenAiPrompts {
    ...
    public static final class Evaluation {
        ...
        public static final String SYSTEM_PROMPT = """
                ...
                - Label bulldozer only when dozer cues are visible, especially a front blade or clearly recognizable dozer body
                - Label excavator or mini_excavator only when excavator cues are visible, such as boom, arm, bucket, house, or excavator undercarriage
                ...
                7b. WEATHER
                - weather_note must be present on every response
                - Keep weather_note short and observational
                - Mention only visible conditions in the current frame
                - Good examples: "overcast", "sunny and dry", "wet ground", "light rain", "foggy"
                - If weather is not visually clear, return "unclear"
                8. TRACKING
                ...
                - When several stationary machines persist in distinct positions across frames, use the prior snapshot only as a consistency check after current-image detection
                - Re-check each persistent machine position before finalizing the JSON
                ...
                - Do not swap the classes or identities of two nearby stationary machines without clear current-image evidence
                ...
                - If no valid allowed-class construction objects are clearly visible, return:
                  {"weather_note":"unclear","detections":[]}
                10. OUTPUT FORMAT
        ...
        public static final String USER_PROMPT_TEMPLATE = """
                ...
                A machine that stays in roughly the same position should keep the same class unless the current frame clearly shows different visual cues.
                Do not silently swap the classes of two persistent nearby machines.
        ...
        public static final Map<String, ClassHint> CLASS_HINTS = Map.ofEntries(
                ...
                Map.entry("other_equipment", new ClassHint("site-relevant equipment that does not fit a more specific class, including drill rigs, piling rigs, or soil drilling machinery"))
        );
    }
}
